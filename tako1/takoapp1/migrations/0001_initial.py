# Generated by Django 4.2.25 on 2025-12-30 15:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('cart', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='takoapp1.cart')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='takoapp1.cart')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='takoapp1.product')),
            ],
        ),
        migrations.CreateModel(
            name='User',
